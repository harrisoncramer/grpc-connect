import { Client, createClient, ConnectError } from "@connectrpc/connect";
...
class ConnectClient {
  greet: Client<typeof GreetService>;
  math: Client<typeof MathService>;
...
async function addNumbers() {
  ...
  try {
    ...
    const e = error as unknown as ConnectError;
